...
// Process builder is deprecated so this no longer works.
//use Symfony\Component\Process\ProcessBuilder;

class StartCommand extends Command
{
// TODO: This is in 1.x, maybe it is not needed for 2.x
//    use ChecksConfig;

    protected static $defaultName = 'mannequin:start';
...
//    }
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        // TODO: This will need to be implemented a bit later. We need to do some work on other commands first.
